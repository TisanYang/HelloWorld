...
class ReplayClientHandler(private val er: RequestReplay) : SimpleChannelInboundHandler<ByteBuf>() {
    ...
    override fun channelActive(ctx: ChannelHandlerContext?) {
        ...
        val header = ByteBuffer.allocate(20 + 24)
        ...
        header.putInt(16, 24)
        header.putChar(20,Char(0))
        header.putChar(24,Char(er.channel))
        header.putShort(28,er.type)
        header.putChar(29,Char(er.luid))
        header.putChar(30,Char(er.isBack))
        header.putShort(31,er.alm)
        header.putLong(32,1695159167)//2023-05-28 15:32:47
        header.putLong(36,1695259167)//2023-09-21 09:19:27
        header.putChar(40,Char(0))
