...
import hf.car.wifi.video.model.GetDmsInfo
...
class GetDmsHandler(private val er: GetDmsInfo) :
    ...
    override fun channelActive(ctx: ChannelHandlerContext?) {
        ...
        //这里是开辟出来的大小
        val header = ByteBuffer.allocate(20 + 4)
        ...
        System.arraycopy(er.dataArray,0,header.array(),20,4)
