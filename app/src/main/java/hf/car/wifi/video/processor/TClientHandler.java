 ...
 * @date: 2020年3月24日
 */
//public class TClientHandler extends ChannelInboundHandlerAdapter {
//
//    private static final Logger logger = Logger.getLogger(TClientHandler.class.getName());
//
...
//
//    public TClientHandler(FileConfig fc) {
